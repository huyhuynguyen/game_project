...
namespace Quizzie
{
    public partial class hardMode : MetroFramework.Forms.MetroForm
    {
        public hardMode()
        {
            InitializeComponent();
        ...
        void Receive(object obj)
        {
            ...
            while (tcpClient.Connected)
            {
                if (ktNext)
                {
                    ...
                    ptbHard1.BackgroundImage = ifs.img1;
                    ptbHard1.Invoke(new MethodInvoker(delegate ()
                    {
                        ptbHard1.BackgroundImageLayout = ImageLayout.Stretch;
                    }));

                    ptbHard2.BackgroundImage = ifs.img2;
                    ptbHard2.Invoke(new MethodInvoker(delegate ()
                    {
                        ptbHard2.BackgroundImageLayout = ImageLayout.Stretch;
                    }));
        ...
        void PhatSinhButtonDapAn()
        {
            ...
            for (int i = 0; i < strAns.Length; i++)
            {
                ...
                if (i == 0)
                {
                    button_DapAn[i].Location = new Point(ptbHard1.Location.X + 15, label5.Location.Y + label5.Size.Height + 20);
                }
                else
                {
        ...
        void PhatSinhButtonGoiYDapAn()
        {
            ...
            button_GoiY[0].Location = new Point(label5.Location.X - 90, button_DapAn[0].Location.Y + button_DapAn[0].Size.Height + 30);
        ...
        int heart;
        private void hardMode_Shown(object sender, EventArgs e)
        {
        ...
        private void hardMode_FormClosing(object sender, FormClosingEventArgs e)
        {
